...
### ★ Скрипты <sup>_`для версии simpleTV b12.7.6 (vlc 3.0.11)`_<sup>
...
###### - если установлен "_видео а́ддон_ [_**videotracks**_](http://iptv.gen12.net/bugtracker/view.php?id=1704 "не рекомендуется")", в его настройках внести в исключения адреса, которые открывают скрипты/плеер
