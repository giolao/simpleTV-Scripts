...
**В некоторых видеоскриптах/скраперах возможно указать**
 - прокси/зеркало
 - различные параметры

---
**Авторизация**
- если видеоскрипт/скрапер поддержиавет, логин/пароль установить в дополнении [Password Manager][PM]
---

⚠ не совместимо со скриптами, "порталом" от _**[west_side](http://iptv.gen12.net/bugtracker/view.php?id=1733)**_

⚠ если установлен "_видео аддон_ [_**videotracks**_](http://iptv.gen12.net/bugtracker/view.php?id=1704 "удаляйте это поделее")", в его настройках внести в исключения адреса, которые открывают видеоскрипты/плеер

⚠ устаревшие, неактуальные, несовместимые скрипты/дополнения будут вызывать конфликты
